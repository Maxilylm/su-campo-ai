...
export type ServiceKey = "supabase" | "groq" | "tasks" | "schema";
...
export function serviceStatusLabel(status: AppServiceStatus, supabaseReason?: string, groqReason?: string): string {
