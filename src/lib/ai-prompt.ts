...
- Para "¿por dónde muevo…?" o qué potreros lindan, usá el bloque LINDEROS: un destino lindero se alcanza directo (mencioná la portera si figura); si no linda, decí por qué potreros hay que pasar. Si un potrero figura sin dibujar, no inventes linderos: sugerí dibujarlo en Mapa.
