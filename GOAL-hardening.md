...
is clean, and the production deploy at https://campo-ai-mlx.vercel.app serves the full flow.
...
- [x] Deployed to Vercel prod; `/login`, `/setup`, and `/api/status` all respond correctly.
      ✓ Done 2026-06-13: deployed to https://campo-ai-mlx.vercel.app. The new /api/status probe caught
